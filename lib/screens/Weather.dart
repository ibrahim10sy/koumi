...
import 'package:koumi/days/Day.dart';
import 'package:koumi/days/DayToday.dart';
import 'package:koumi/models/OpenWeatherAPI.dart';
import 'package:koumi/models/WeatherData.dart';
import 'package:koumi/widgets/DetectorPays.dart';
import 'package:koumi/widgets/Tabs.dart';
import 'package:koumi/widgets/loader.dart';
...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  // void setLocaleToFrench() {
  //   Intl.systemLocale = 'fr_FR';
  // }
  @override
  void dispose() {
  ...
  checkLocationStatus() async {
    ...
    if (!serviceEnabled) {
      setState(() {
        isError = true;
        error =
            "Les services de localisation sont désactivés. Veuillez les activer et redémarrer l'application.";
      });
      return;
    }
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission == LocationPermission.denied) {
        setState(() {
          isError = true;
          error =
              "Les autorisations de localisation sont refusées. Veuillez les autoriser pour utiliser cette fonctionnalité.";
        });
        return;
      }
    }
    ...
    if (permission == LocationPermission.deniedForever) {
      setState(() {
        isError = true;
        error =
            "Les autorisations de localisation sont refusées de manière permanente. Veuillez les autoriser dans les paramètres de l'application.";
      });
      return;
    }
  ...
  String getDay(final day) {
    ...
    // String dayName = DateFormat('EEEE', 'fr_FR').format(time);
    days.add(dayName);
    return dayName;
  }
              ...
              child: ListView(
                ...
                children: [
                  ...
                  DataTable(
                    ...
                    rows: [
                      DataRow(cells: [
                        DataCell(Text("Vitesse du vent",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                        DataCell(Text("Vitesse du vent, m/s",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                      ...
                      DataRow(cells: [
                        DataCell(Text("Degré de vent",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                        DataCell(Text(
                            "Direction du vent, degrés (météorologiques).",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                      ...
                      DataRow(cells: [
                        DataCell(Text("Pression",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                        DataCell(Text(
                            "Pression atmosphérique au niveau de la mer, hPa",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                      ...
                      DataRow(cells: [
                        DataCell(Text("Indices UV",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                        DataCell(Text(
                            "L'intensité des UV du soleil varie de 0 à 11+.",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                      ...
                      DataRow(cells: [
                        DataCell(Text("Visibilité",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                        DataCell(Text(
                            "Visibilité moyenne, mètres. La valeur maximale de la visibilité est de 10 km.",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                      ...
                      DataRow(cells: [
                        DataCell(Text("Nuages",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                        DataCell(Text("Nébulosité, %",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                      ...
                      DataRow(cells: [
                        DataCell(Text("Point de rosée",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                        DataCell(Text(
                            "Température en dessous de laquelle les gouttelettes d'eau forment une rosée.",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                      ...
                      DataRow(cells: [
                        DataCell(Text("Rafale de vent",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
                        DataCell(Text(
                            "Une rafale de vent est une rafale soudaine de vent à grande vitesse.",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium
                                ?.copyWith(fontSize: 14))),
